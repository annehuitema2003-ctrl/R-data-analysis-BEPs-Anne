#debug/verification script --> reconstruct all costs from the raw tables, 
#verify that spendable income is consistent,
#dump everything to Excel, then produce a spending plot.”
